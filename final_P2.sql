...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            DBMS_OUTPUT.PUT_LINE('PLEASE CHECK YOUR DATE IS FORMATTED AS DD-MON-YY LIKE 02-DEC-19');
            INSERT INTO ERR_LOG VALUES('CUSTOMERINFO(TRIPLE INPUT)', NULL, SYSDATE, NULL, NULL);        
            RETURN NULL;
END;    
/
...
CREATE OR REPLACE PACKAGE BODY INSERT_PKG AS
    ...
    EXCEPTION
        WHEN OTHERS THEN
            DBMS_OUTPUT.PUT_LINE('PLEASE CHECK YOUR INPUTS AND RETRY');
...
CREATE OR REPLACE TRIGGER ON_EMP_DELETION
    ...
    EXCEPTION
        WHEN OTHERS THEN
            DBMS_OUTPUT.PUT_LINE('PLEASE CHECK YOUR ARE NOT MISSING A CRITICAL VALUE');
